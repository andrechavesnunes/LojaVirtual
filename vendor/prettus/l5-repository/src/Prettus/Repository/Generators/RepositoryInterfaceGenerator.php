 ...
 * @package Prettus\Repositories\Generators
 */
class RepositoryInterfaceGenerator extends Generator
{
    ...
    {
        return $this->getBasePath() . '/' . parent::getConfigGeneratorClassPath($this->getPathConfigNode(), true) . '/' . $this->getName() . 'Repositories.php';
    }
