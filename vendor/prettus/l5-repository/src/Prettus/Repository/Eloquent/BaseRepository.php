 ...
 * @package Prettus\Repositories\Eloquent
 */
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of Prettus\\Repositories\\Contracts\\PresenterInterface");
            }
    ...
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of Prettus\\Repositories\\Contracts\\CriteriaInterface");
        }
